...
**Scope:** the five unresolved spikes in [../05-open-questions.md](../../archive/open-questions.md) that external research can answer.
...
- At 18.5 tok/s, a 60-token teacher utterance costs **3.2 s of generation alone**, before prefill. The pre-registration pattern in [../07-execution-plan.md](../../archive/execution-plan.md) §3 is not an optimization — it is the only way this is usable live.
