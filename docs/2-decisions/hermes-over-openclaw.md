# 01 — DECISION: Hermes or OpenClaw?
...
- The Hermes API server proves unstable across `0.2x` releases (measured by our own evals — see [open questions](../4-build/open-questions.md))
