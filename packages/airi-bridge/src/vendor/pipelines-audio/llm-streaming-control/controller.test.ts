 ...
 * Source: packages/pipelines-audio/src/llm-streaming-control/index.test.ts
 ...
 *
 * Upstream test. Only the import path changed (`./index` -> `./controller`).
 */

import { describe, expect, it, vi } from 'vitest'

import { createStreamingControlParser } from './controller'
