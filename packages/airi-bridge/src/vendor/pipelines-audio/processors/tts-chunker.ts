 ...
 * Source: packages/pipelines-audio/src/processors/tts-chunker.ts
 ...
 *
 * Verbatim. Carries PROTOCOL.md §6 invariant 1: `boost = 2` lets the first two segments
 * bypass the minimum-word rule, cutting time-to-first-audio.
 * Known upstream behaviour, intentionally NOT "fixed": grapheme clusters longer than one
 * code unit (emoji, some CJK sequences) are dropped from TTS input.
 */
