 ...
 * Source: packages/pipelines-audio/src/managers/playback-manager.ts
 ...
 *
 * Deviation: `errorMessageFrom` now comes from the local `../utils/error-message`
 * instead of `@moeru/std`, to avoid a pre-release dependency for a single helper.
 * Behaviour is identical. Nothing else changed.
 */
